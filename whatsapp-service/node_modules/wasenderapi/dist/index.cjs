...
__export(index_exports, {
  ...
  Wasender: () => Wasender,
  WasenderAPIError: () => WasenderAPIError,
  WasenderWebhookEventType: () => WasenderWebhookEventType,
  createWasender: () => createWasender,
  verifyWasenderWebhookSignature: () => verifyWasenderWebhookSignature
});
...
var WasenderWebhookEventType = {
  ...
  // Message status update (e.g., delivered, read by recipient)
  ...
  // Message successfully sent *from your session*
